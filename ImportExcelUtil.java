...
import com.like.entity.XDiningHall;
import com.like.entity.XDiningHallimport;
...
//		try {
//			 FileInputStream in = new FileInputStream("C:\\Users\\Administrator\\Desktop\\DAN.xls");
//			 List<XDiningHallimport> list = convertSheetToList(in,0, XDiningHallimport.class, true, 2, 500);
